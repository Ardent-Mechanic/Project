...
from window.new_attempt1 import Ui_Form as mainwindow
...
class WorkThread1(Qt.QThread):
    ...
    def __init__(self, box, database_name, btn):
...
class MainWindow(QMainWindow, mainwindow):
    ...
    def startExecuting1(self, *args):
        ...
        if args[0] == 2:
            ...
            self.thread1 = WorkThread1(args, self.db_link, self.run)
        ...
        if dialog_for_question.exec_() == QtWidgets.QDialog.Accepted:
            if dialog_for_question.com:
                try:
                    ...
                    print(ex)
                    self.msg4.setText(f"Database not found:{ex}")
                    self.msg4.show()
